...
export const mockInvitations = [
  {
    invitationId: 201,
    type: 1,
    title: "[초대] '코드마스터' 팀에서 함께하실 백엔드 개발자를 찾고 있습니다",
    content:
      "저희 팀은 현재 AI 기반 서비스를 기획 중입니다. 고객님의 <strong>백엔드</strong> 역량이 팀에 꼭 필요합니다.",
    sender: { userId: 45, userName: "박민준 팀장" },
    position: 3,
  ...
  },
  {
    invitationId: 202,
    type: 2,
    title: "[요청] 기획자 직군으로 팀에 합류하고 싶습니다",
    content:
      "안녕하세요. 해커톤 경험이 있는 <u>서비스 기획자</u> 최서연입니다. 일정과 주제에 공감해 팀에 합류하고 싶습니다.",
    sender: { userId: 72, userName: "최서연" },
    position: 1,
  ...
  },
  {
    invitationId: 203,
    type: 1,
    title: "[초대] '디자인랩' 팀에서 디자이너로 합류 제안드립니다",
    content:
      "포트폴리오가 매우 인상 깊었습니다. 우리 팀은 <strong>UI/UX 디자이너</strong>를 담당해 주실 분을 찾고 있습니다.",
    sender: { userId: 33, userName: "이소율" },
    position: 4,
  ...
  },
  {
    invitationId: 204,
    type: 2,
    title: "[요청] 프론트엔드 개발로 지원합니다 (React/Tailwind)",
    content:
      "성능 최적화에 관심이 많은 프론트엔드 개발자입니다. 재사용 가능한 컴포넌트 구조로 프로젝트를 함께 완성하고 싶습니다.",
    sender: { userId: 88, userName: "강다예" },
    position: 2,
  ...
  },
  {
    invitationId: 205,
    type: 1,
    title: "[초대] 함께 서비스를 그려볼 기획자를 찾습니다",
    content:
      "비즈니스 모델 구성이 강점인 <u>기획자</u>를 모시고 있습니다. 현재 개발 인력과 디자인 인력은 구성된 상태입니다.",
    sender: { userId: 15, userName: "서유진" },
    position: 1,
