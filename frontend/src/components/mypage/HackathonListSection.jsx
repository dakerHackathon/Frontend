      ...
      <section className={`${cardClass} space-y-3`}>
        ...
        <div className="relative">
          <div
            ...
            className="smart-scroll max-h-[320px] space-y-2 overflow-y-auto"
          >
          ...
          {isScrolling && thumbStyle.visible ? (
            <div
              className="pointer-events-none absolute -right-2 rounded-full bg-slate-400/45 transition-opacity duration-150"
